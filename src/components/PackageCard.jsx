const PackageCard = ({ name, content, img }) => (
    <div className="flex justify-between flex-col  max-w-[400px] bg-white md:mr-10 sm:mr-5 mr-0 my-5">
      ...
      <p className="font-poppins font-normal px-[30px] py-[30px] text-justify text-[16px] px-[0.5rem] py-[1rem] leading-[24px] text-dimWhite">
        {content}
      </p>
    </div>
  );
