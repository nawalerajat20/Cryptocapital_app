  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-[1] flex flex-col justify-start mr-10">
        ...
        <p className={`${styles.paragraph} text-white text-[20px] mt-8 font-semibold`}>
          Organiser
        </p>
        <p className={`${styles.paragraph} text-white text-[20px] mt-8 font-medium`}>
      ...
      <div className="flex-[1.5] w-full text-primary flex flex-row justify-between flex-wrap md:mt-0 mt-10">
